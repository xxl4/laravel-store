...
class Delete extends Command
{
     ...
     * @var string
     */
    protected $signature = 'products:TM:delete:online {store} {prod_id} {data?}';
    ...
    public function handle()
    {
        ...
        //@link https://open.taobao.com/api.htm?docId=53970&docType=2&source=search
        $req = new \AlibabaItemOperateDeleteRequest();
