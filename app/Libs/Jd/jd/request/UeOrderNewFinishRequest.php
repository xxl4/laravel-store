...
class UeOrderNewFinishRequest
{
	...
	public function getEngineerPhoto(){
	  return $this->engineerPhoto;
                        	                   			...
                        	                   			private $pidPhotoFront;
    	                        
	public function setPidPhotoFront($pidPhotoFront){
		$this->pidPhotoFront = $pidPhotoFront;
         $this->apiParas["pidPhotoFront"] = $pidPhotoFront;
	}

	public function getPidPhotoFront(){
	  return $this->pidPhotoFront;
	}

                        	                   			private $pidPhotoBack;
    	                        
	public function setPidPhotoBack($pidPhotoBack){
		$this->pidPhotoBack = $pidPhotoBack;
         $this->apiParas["pidPhotoBack"] = $pidPhotoBack;
	}

	public function getPidPhotoBack(){
	  return $this->pidPhotoBack;
	}
